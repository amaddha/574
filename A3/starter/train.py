...
# paths you may want to adjust, but it's better to keep the defaults    
    parser.add_argument("--checkpoint_folder", default="/Users/abhim/Downloads/starter/checkpoints/", type=str, help="Folder to save checkpoints")
    parser.add_argument("--resume_file", default="/Users/abhim/Downloads/starter/model_best.pth.tar", type=str, help="Path to retrieve latest checkpoint file relative to checkpoint folder")
    parser.add_argument("--train_folder", default="/Users/abhim/Downloads/starter/dataset/train/", type=str, help="Folder where training data are stored")
    parser.add_argument("--val_folder", default="/Users/abhim/Downloads/starter/dataset/val/", type=str, help="Folder where validation data are stored")
    parser.add_argument("--test_folder", default="/Users/abhim/Downloads/starter/dataset/test/", type=str, help="Folder where test data are stored")    
 ...
 # various options for testing and evaluation
    ...
    parser.add_argument("--distance_threshold", default=0.02, type=float, 
